--[[
    ...
    I-upload ang file na ito sa hosting mo (halimbawa GitHub raw), tapos i-set ang
    URL nito sa PiLib_HttpGet.lua. Bumalik ito ng PiLib table para sa loadstring.

    Usage:
        local PiLib = loadstring(game:HttpGet("URL_NG_FILE_NA_ITO", true))()
    ================================================================================
--]]
...
function Creator.AdaptiveTween(instance, targetProps, duration, easingStyle, easingDir)
    ...
    -- On Mobile / Touch, use fast linear or quad tweens to minimize rendering overhead
    if isTouch then
...
function PiLib:CreateWindow(config)
    ...
    closeBtn.Activated:Connect(function()
        WindowObj:Dialog({
            ...
            Content = "Sigurado ka bang nais mong isara ang interface?",
            Buttons = {
                {
                    Title = "Cancel"
                },
...
function SaveManager:Delete(configName)
    ...
    if isfile(fullPath) then
        ...
        -- Kapag ang dinelete na profile ang naka-autoload, i-clear din ang autoload
...
function SaveManager:BuildConfigSection(tab)
    ...
    -- Ang button title ay laging nagpapakita ng aktibong autoload profile
